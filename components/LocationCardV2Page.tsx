...
interface LocationCardV2PageProps {
  ...
  zoom?: string;
  locationName?: string;
  addressLocations_change_051225?: string;
...
export default function LocationCardV2Page({
  ...
  zoom = '10',
  locationName,
  addressLocations_change_051225: addressLocations_change_051225,
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          {/* Primary marker info */}
          {(locationName || addressLocations_change_051225) && (
            <div className="mt-3 text-sm text-gray-700 dark:text-gray-300">
              {locationName && <div className="font-semibold">{locationName}</div>}
              {addressLocations_change_051225 && <div>{addressLocations_change_051225}</div>}
            </div>
          )}
        </div>
